...
BookCopy.create(isbn:book1.isbn, status:"Available", book_id:book1.id)
BookCopy.create(isbn:book2.isbn, status:"Available", book_id:book2.id)
BookCopy.create(isbn:book3.isbn, status:"Available", book_id:book3.id)
BookCopy.create(isbn:book4.isbn, status:"Available", book_id:book4.id)
